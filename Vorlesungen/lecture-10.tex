...
\defineTitle{10}{Grenzen regulärer Sprachen / Probleme~für~Automaten}{13. November 2017}
...
\theobox{Satz: Wenn $\simeq_{\Slang{L}}$ unendlich viele Äquivalenzklassen hat, dann ist $\Slang{L}$ nicht regulär.}%
\medskip\pause
...
\theobox{Satz: Das Wortproblem für DFAs kann in polynomieller Zeit entschieden werden.}\pause
...
\theobox{Satz: Das Wortproblem für reguläre Sprachen kann in linearer Zeit $O(|w|)$ entschieden werden.}\pause
