...
\defineTitle{1}{Willkommen/Einleitung formale Sprachen}{9. Oktober 2017}
...
\item Ein \redalert{Suffix} von $w$ ist ein Wort $\Sterm{a_j}\ldots \Sterm{a_n}$ mit $0\leq j \leq n + 1$
