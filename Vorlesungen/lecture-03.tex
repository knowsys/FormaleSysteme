...
\defineTitle{3}{Endliche Automaten}{19. Oktober 2025}
...
\ghost{\hspace{9.2cm}\includegraphics[width=3.5cm]{images/BNF-Autoren} ~\rotatebox{90}{{\tiny{oben: John Backus, Peter Naur}}} \rotatebox{90}{{\tiny{unten: Niklaus Wirth, Panini}}}}%
\pause\redalert{Erweiterte BNF} (EBNF, von Niklaus Wirth):
\begin{itemize}
