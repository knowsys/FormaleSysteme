...
{\footnotesize $^1$ Hierbei muss eine leicht modifizierte Form von "`Inkrementierung"' verwendet werden, welche die folgende Sequenz erzeugt: $0,1,\ldots,\ell,00,01,\ldots,0\ell,10,11,\ldots,\ell\ell,000,001,\ldots$
