...
\defineTitle{16}{Kellerautomaten \& CFGs}{8. Dezember 2025}
...
Die \alert{Grammatik $G_{\Smach{P}}$} besteht aus den folgenden Regeln:
...
Dann ist $\Slang{L}(\Smach{P})=\Slangsub{L}{$q_0,q_f$}$. Die Grammatik $G_{\Smach{P}}$ erzeugt diese Sprache,
...
% \begin{frame}\frametitle{Lehrevaluation WiSe 2025/2026}
% 
% % \huge
% \narrowcentering{\includegraphics[height=5cm]{local_lehreval_2025_qrcode}}
% 
% \begin{center}\Large
% \url{https://befragung.zqa.tu-dresden.de/uz/}\\(Token: \alert{\texttt{Hetbozefaf}})\bigskip
% % 
% % 10min zum Ausfüllen der Fragebögen
% \end{center}
% 
% \end{frame}
