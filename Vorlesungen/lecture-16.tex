...
\defineTitle{16}{Kellerautomaten \& CFGs}{4. Dezember 2017}
...
\item Übergänge ohne \texttt{pop} oder \texttt{push}, stellt man dar, indem man zunächst ein Hilfsszeichen \texttt{push}t und dieses gleich darauf wieder \texttt{pop}t
\end{itemize}}
