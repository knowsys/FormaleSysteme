...
\defineTitle{21}{Aussagenlogik}{18. Januar 2021}
...
% \bigskip
% 
% \praise{viele Beweise}\\[1ex]
% \critique{Viele Beweise hindern das Verstehen}\\[1ex]
% \critique{Weniger Algorithmen, mehr Beweise}\\[1ex]
% \praise{gestaltet die VL im idealen Tempo und hat eine sehr gute Präsentationsart}\\[1ex]
% \critique{Die Geschwindigkeit ist so hoch, das man nicht mitschreiben kann.}\\[1ex]
% \critique{langsamer sprechen}
% 
% \end{frame}
% 
...
% % \end{frame}
% 
% \begin{frame}\frametitle{Kommentare: Folien vs. Tafel}
% 
% \textbf{\textcolor{darkgreen}{\ldots besonders gut gefallen?}}\hfill\textbf{\textcolor{darkred}{Verbesserungswünsche?}}
% \bigskip
% 
% \praise{sehr gute Folien}\\[0.5ex]
% \praise{anschauliche Folien}\\[0.5ex]
% \praise{sehr schöne Folien}\\[0.5ex]
% \praise{sehr gut erklärende Folien}\\[0.5ex]
% \praise{Übersichtliche Folien}\\[0.5ex]
% \praise{Visualisierungen sind on point.}\\[0.5ex]
% \critique{Mehr mit Tafel arbeiten}\\[1ex]
% \critique{Schreiben Sie mehr an die Tafel, damit wir etwas zum Schreiben haben}\\[1ex]
% \critique{Eine traditionelle Vorlesung an der Tafel oder mit Stift auf Polylux würde automatisch die optimale Stoffmenge geben und das Lernen vereinfachen.}
% 
% \end{frame}
% 
