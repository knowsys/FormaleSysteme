...
\item Aber: Es gibt mehr Möglichkeiten, unendlich viele Fragen zu beantworten, als es Algorithmen geben kann (Georg Cantor)
\end{itemize}
...
LOOP hat nur wenige Ausdrucksmittel, aber man kann sich leicht weitere als Makros definieren.\footnote{Nutzen Sie zum Testen auch unseren \href{https://tools.iccl.inf.tu-dresden.de/while/}{\alert{LOOP-Simulator [Link]}} online.}\\[1ex]
...
\addtocounter{footnote}{-1} % repeat footnote with previous counter here
LOOP hat nur wenige Ausdrucksmittel, aber man kann sich leicht weitere als Makros definieren.\footnote{Nutzen Sie zum Testen auch unseren \href{https://tools.iccl.inf.tu-dresden.de/while/}{\alert{LOOP-Simulator [Link]}} online.}\\[1ex]
...
\item Wir betrachten $\Sseq$ als ein Zeichen (und Zeilenumbrüche ebenso)
...
\begin{frame}\frametitle{WHILE: Beobachtungen\footnote{Unser Online-Tool funktioniert auch als \href{https://tools.iccl.inf.tu-dresden.de/while/}{\alert{WHILE-Simulator [Link]}}.}}
...
(für ein frisches $\Svar{z}$)\medskip
...
Online-Simulator für WHILE und LOOP (mit kleinen syntaktischen Verbesserungen wie Kommentaren): \url{https://tools.iccl.inf.tu-dresden.de/while/}
\bigskip
