...
\defineTitle{8}{Minimale Automaten}{10. November 2025}
...
$\simquot{\Smach{M}}=\tuple{\simquot{Q},\Sigma,\delta_{\sim},[q_0]_{\sim},\simquot{F\!}}$ wobei gilt:%
\begin{itemize}
...
\begin{itemize}
\item wenn $[q]_{\sim}=[p]_{\sim}$ dann $[\delta(q,\Sterm{a})]_{\sim}=[\delta(p,\Sterm{a})]_{\sim}$ (Verträglichkeit von $\sim$ und $\delta$; benötigt totale Übergangsfunktion)
