...
\defineTitle{2}{Grammatiken und die Chomsky-Hierarchie}{16. Oktober 2025}
...
%
für ein $n\geq 1$ und beliebige Wörter $w_1,\ldots,w_n\in (V\cup\Sigma)^*$ gilt.
...
\emph{Beweis (Forts.):} Der "`rekursiv konstruierte Beweis"' ist natürlich eine \ghost{\redalert{vollständige Induktion}:}
\medskip
