...
\defineTitle{9}{Minimale Automaten (2)}{13. November 2025}
...
\begin{tikzpicture}[baseline={(current bounding box.center)}]
% \draw[help lines] (0,0) grid (7,2);
\node (s1) [circle,draw=black,thick,onslideprint={<12->{double}}] at (0,0) {$[\epsilon]_\simeq$};
\node (s2) [circle,draw=black,thick,onslideprint={<12->{double}}] at (2,0) {$[\Sterm{a}]_\simeq$};
