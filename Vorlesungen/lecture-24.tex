...
\defineTitle{24}{Typ 0 und Typ 1}{22. Januar 2026}
...
\item alle "`echten"' \alert{Programmiersprachen} (C, Java, PHP, Python, JavaScript, C++, BASIC, Perl, C$^\sharp$, Fortran, 
{\footnotesize Pascal, Lua, Ruby, COBOL, Assembler, Lisp, Visual Basic, MATLAB, Ada, Go, Prolog, R, Haskell, Rust, 
...
%%% Query:
% SELECT ?language ?languageLabel (COUNT(DISTINCT ?article) AS ?wikipediaArticleCount) WHERE {
...
\emph{Beweis:} Das Komplement des Halteproblems ist nicht semi-entscheidbar (siehe Vorlesung 24).\qed
% \pause\bigskip
