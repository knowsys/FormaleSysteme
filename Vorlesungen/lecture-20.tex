...
$\bbfunc(n)$: & $1$ & $4$ & \visible<3->{$6$} & \visible<4->{$13$} & \visible<5->{$4098$\footnote{\visible<5->{Erstmals bewiesen 2024, publiziert in \href{https://arxiv.org/abs/2509.12337}{Blanchard et al.: "`Determination of the fifth Busy Beaver value"', Sept 2025 [link]}}}} & \visible<6->{$\geq 3,5\times 10^{18267}$} & \visible<7->{riesig} & \visible<8->{irrsinnig}
\end{tabular}
\bigskip
