...
\defineTitle{17}{Deterministische Sprachen / Entscheidungsprobleme}{11. Dezember 2025}
...
Laut Pumpinglemma ist $z=uvwxy$ mit $|vx|\leq n$ und $uv^0wx^0y=uwy\in\Slang{L}(G)$. \pause Da $uwy$ kürzer ist als $z$
...
\examplebox{\emph{Beispiel:} Die Sprache $\{\Sterm{a}^i\Sterm{b}^i\Sterm{c}^i\mid i\geq 0\}$ ist nicht
