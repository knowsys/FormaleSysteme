...
\defineTitle{14}{Abschlusseigenschaften kontextfreier Sprachen}{27. November 2017}
...
\examplebox{Beispiel: Das Komplement der nicht-regulären Sprache $\Slang{L}=\{\Sterm{a}^i\Sterm{b}^i\mid i\geq 0\}$ über dem Alphabet $\{\Sterm{a},\Sterm{b}\}$ ist
