...
Online-Simulator für LOOP und WHILE$^{(++)}$ (+Abkürzungen, +Kommentare):\\ \alert{\url{https://tools.iccl.inf.tu-dresden.de/while/}}
...
\ghost{\hspace{7.4cm}\rotatebox{90}{\textcolor{devilscss}{{\tiny Vgl. 13. Übung, Aufg. 4: Mit $\Slang{P}_{\textsf{Halt}}$ kann man alle semi-entscheidbaren Probleme lösen}}}}
