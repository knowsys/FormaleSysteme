...
\begin{frame}\frametitle{Beispiel}
% Notfalls Folie CB 25-10 95ff
\end{frame}

\begin{frame}\frametitle{Beiweis der Korrektheit des Produktautomaten}
% Notation, Uebersicht
\end{frame}

\begin{frame}\frametitle{Inklusion PD-Sprache in Schnitt}
\end{frame}

\begin{frame}\frametitle{Inklusion Schnitt in PD-Sprache}
\end{frame}
...
\begin{frame}\frametitle{Komplementoperator für NFAs}
...
% Fuer Abschluss unter circ und * brauchen wie esp NFA
