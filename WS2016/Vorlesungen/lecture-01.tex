...
\examplebox{Beispiel:
Die Menge aller gültigen Schreibweisen für Dezimalzahlen kann wie folgt definiert werden:\\[1ex]

\narrowcentering{$ \Slang{Dezimalzahl} =  \big(\{\epsilon\}\cup \{\Sterm{+},\Sterm{-}\}\big) \circ \big(\{\Sterm{0}\}\cup \Slang{ZifferAb1}^+\big) \circ \big( \{\epsilon\}\cup \{\Sterm{.}\}\Slang{Ziffer}^+ \big) $}\\[1ex]
