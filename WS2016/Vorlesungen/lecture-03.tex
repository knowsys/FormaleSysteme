...
\ghost{\hspace{7.2cm}\includegraphics[width=3.5cm]{images/BNF-Autoren} ~\rotatebox{90}{{\tiny{oben: John Backus, Peter Naur}}} \rotatebox{90}{{\tiny{unten: Nicklas Wirth, Panini}}}}%
...
(2) \ghost{$q_0\Rightarrow \Sterm{a_1}q_1 \Rightarrow\ldots \Rightarrow\Sterm{a_1\cdots a_{n-1}}q_{n-1}\Rightarrow \Sterm{a_1\cdots a_{n-1}a_n} q_n \Rightarrow \Sterm{a_1\cdots a_{n-1}}$}
\bigskip\pause
