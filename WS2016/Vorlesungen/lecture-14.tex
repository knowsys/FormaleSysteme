...
%
\narrowcentering{$G_1\uplus G_2=\tuple{V_1\cup V_2\cup\{\Snterm{S}\},\Sigma,P_1\cup P_2 \cup \{ \Snterm{S}\to \Sntermsub{S}{1}\mid \Sntermsub{S}{2}\},\Sntermsub{S}{1}}$,}\\[1ex]
%
...
%
\narrowcentering{$G_1\circ G_2=\tuple{V_1\cup V_2\cup\{\Snterm{S}\},\Sigma,P_1\cup P_2 \cup \{ \Snterm{S}\to \Sntermsub{S}{1}\Sntermsub{S}{2}\},\Sntermsub{S}{1}}$,}\\[1ex]
%
wobei $\Snterm{S}$ ein neues Startsymbol ist, das nicht in $V_1\cup V_2$ vorkommt.
}
...
$G_1$ sei die Grammatik mit er einen Regel $\Sntermsub{S}{1}\to \Sterm{a}$
