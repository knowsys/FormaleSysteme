...
% 
\narrowcentering{$\{\textsf{enc}(G_1)\#\textsf{enc}(G_2)\mid \Slang{L}(G_1)=\Slang{L}(G_2)\text{ oder }G_1\text{ bzw. }G_2\text{ keine CFG}\}$}\\[1ex]
% 
...
Ein Mechanismus zur Generischen Programmierung in C++, bei dem zur Compilezeit (beliebig viele) Code-Templates instantiiert werden. Insbesondere ist die Frage, ob ein C++-Compiler hält nicht entscheidbar.
